...
- Two-database architecture (Market DB + Client DB)
- GP fund profiles and onboarding
- 36-agent matching system
- Shortlist and basic pipeline tracking
- Pitch generation
- Admin dashboard with proper structure
- Financial Analyst data curation tools
- Health dashboards (Data, GP)

**IMPORTANT (Middle Milestones):**
- LP→GP bidirectional matching
- LP dashboard and workflows
- Mutual interest detection
- Team member management
- Outreach pipeline (manual tracking)

**DEFERRABLE (Later Milestones):**
- Email sync (Gmail, Outlook OAuth)
- Calendar sync (Google, Microsoft OAuth)
- CRM integrations (Salesforce, HubSpot)
- Scheduling links (Calendly-style)
- Learned ensemble weights (needs outcome data)

---

### Revised Milestone Overview
...
*Section 19 complete. Revised milestone roadmap with essential features first, integrations later.*
