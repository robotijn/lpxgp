...
<body>
    ...
    <div class="cover">
        ...
        <div class="tagline">Powered by 42 AI agents working 24/7—researching, debating, and verifying every LP match before it reaches you.</div>
        <div class="stats-row">
            <div class="stat">
    ...
    <div class="toc">
        ...
        <div class="toc-item"><span>The 42 Specialized AI Agents</span></div>
...
└─────────────────┘     └────────┬────────┘     └─────────────────┘
    ...
    <div class="section">
        ...
        <div class="highlight-box">
            <strong>Competitive Moat:</strong> LPxGP's multi-agent debate system represents a fundamentally different approach to AI-powered matching. Rather than using a single model that can hallucinate or miss nuances, we deploy 42 specialized agents that argue, critique, and synthesize—producing higher-quality results with built-in verification and explainability.
        </div>
        ...
        <h2>The 42 Specialized Agents</h2>
